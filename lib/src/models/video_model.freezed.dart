...
abstract class $VideoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({Uint8List? thumbnail, String url});
}
...
class _$VideoModelImpl with DiagnosticableTreeMixin implements _VideoModel {
  const _$VideoModelImpl({this.thumbnail, required this.url});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'VideoModel(thumbnail: $thumbnail, url: $url)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(thumbnail), url);
